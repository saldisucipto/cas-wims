...
<head>
    ...
    <title>Kartu Stok Consumable - {{ $consumable->name }} - WIMS</title>
...
<body>
    <div class="print-container">
        ...
        <div class="action-bar">
            <span class="action-title">Pratinjau Cetak - Kartu Stok Consumable</span>
        ...
        <div class="print-header">
            ...
            <div class="title">Laporan Kartu Stok Consumable</div>
        </div>

        <div class="info-section">
            <div class="info-grid">
                <div><span class="label">Nama Consumable</span>: <span class="value">{{ $consumable->name }}</span></div>
                <div><span class="label">SKU</span>: <span class="value">{{ $consumable->sku ?: '-' }}</span></div>
                <div><span class="label">Satuan</span>: <span class="value">{{ $consumable->unit }}</span></div>
