...
<head>
    ...
    <title>Rekap Kartu Stok ATK - WIMS</title>
...
<body>
    <div class="print-container">
        ...
        <div class="action-bar">
            <span class="action-title">Pratinjau Cetak — Rekap Kartu Stok ATK</span>
        ...
        <div class="print-header">
            ...
            <div class="title">Rekap Kartu Stok ATK</div>
        </div>
        ...
        <div class="summary-row">
            <div class="summary-card">
                <div class="card-label">Jumlah Jenis ATK</div>
                ...
                @empty
                    <tr>
                        <td colspan="7" style="text-align:center;padding:16px;color:#94a3b8;">
                            Tidak ada data ATK pada periode ini.
                        </td>
                    </tr>
                @endforelse
            </tbody>
