...
@section('title', 'Stock Adjustment - WIMS')
    ...
    <main class="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
        <section class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm shadow-slate-300/40">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-slate-900">Stock Adjustment</h1>
            ...
            <form action="{{ route('administration.inventory.adjustment.store') }}" method="POST"
                ...
                <button class="rounded-lg bg-blue-700 px-3 py-2 text-sm font-semibold text-white">Post Adjustment</button>
            </form>

            <h2 class="mt-8 text-lg font-semibold text-slate-900">Latest Adjustment</h2>
